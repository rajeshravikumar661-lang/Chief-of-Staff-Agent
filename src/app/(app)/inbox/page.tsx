 ...
 * (GET /api/search?q=). Email/All are search over synced messages; the
 * WhatsApp filter surfaces the link/manage flow (there's no WhatsApp
 * message feed to search yet, only the pairing status).
 */
